...
--
-- Host: localhost:3306
-- Generation Time: Jan 08, 2023 at 09:24 PM
...
--
-- Table structure for table `glassdata`
--

CREATE TABLE `glassdata` (
...
--
-- Dumping data for table `glassdata`
--

INSERT INTO `glassdata` (`index`, `RI`, `Na`, `Mg`, `Al`, `Si`, `K`, `Ca`, `Ba`, `Fe`, `Class`) VALUES
